(ns org.parkerici.pret.import.engine.parse.matrix
  (:require [org.parkerici.pret.import.engine.parse.data :as parse.data]
            [org.parkerici.pret.db.metamodel :as metamodel]
            [org.parkerici.pret.util.collection :as util.coll]
            [org.parkerici.pret.util.uuid :as util.uuid]
            [org.parkerici.pret.import.engine.parse.matrix-file :as parse.matrix-file]))
...
(defn matrix->entity
  ...
  (let [data-type-key (metamodel/matrix-data-type-attr schema node-kind)
        ...
        key-pt1 (util.uuid/v5 "pret.matrix" parsed-mtx-file)
        key (str key-pt1 ".tsv")
