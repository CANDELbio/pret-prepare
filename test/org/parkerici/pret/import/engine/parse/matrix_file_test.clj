(ns org.parkerici.pret.import.engine.parse.matrix-file-test
  (:require [org.parkerici.pret.import.engine.parse.matrix-file :as sut]
  ...
  (testing "file with wrong col name throws."
    ...
    (is (thrown-with-msg? Exception
                          ...
                          (sut/parse-matrix-file
                            bad-dense-file
                            sparse-parse-directive))))
  ;; disable until record specs can be loaded generically via data
  #_(let [broken-matrix-directive (assoc dense-parse-directive
